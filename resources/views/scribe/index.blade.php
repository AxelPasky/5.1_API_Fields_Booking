    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-PUTapi-user">PUT api/user</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-logout">
                                <a href="#endpoints-POSTapi-logout">POST api/logout</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-fields">
                                <a href="#endpoints-GETapi-fields">GET api/fields</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-fields--field_id-">
                                <a href="#endpoints-GETapi-fields--field_id-">GET api/fields/{field_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-fields--field_id--availability">
                                <a href="#endpoints-GETapi-fields--field_id--availability">GET api/fields/{field_id}/availability</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-bookings-calculate-price">
                                <a href="#endpoints-POSTapi-bookings-calculate-price">POST api/bookings/calculate-price</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-bookings">
                                <a href="#endpoints-GETapi-bookings">GET api/bookings</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-bookings--booking_id-">
                                <a href="#endpoints-GETapi-bookings--booking_id-">GET api/bookings/{booking_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-bookings">
                                <a href="#endpoints-POSTapi-bookings">POST api/bookings</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-bookings--booking_id-">
                                <a href="#endpoints-PUTapi-bookings--booking_id-">PUT api/bookings/{booking_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-bookings--booking_id-">
                                <a href="#endpoints-DELETEapi-bookings--booking_id-">DELETE api/bookings/{booking_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-admin-statistics-revenue">
                                <a href="#endpoints-GETapi-admin-statistics-revenue">GET api/admin/statistics/revenue</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-admin-statistics-field-performance">
                                <a href="#endpoints-GETapi-admin-statistics-field-performance">GET api/admin/statistics/field-performance</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-admin-fields">
                                <a href="#endpoints-POSTapi-admin-fields">POST api/admin/fields</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-admin-fields--field_id-">
                                <a href="#endpoints-PUTapi-admin-fields--field_id-">PUT api/admin/fields/{field_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-admin-fields--field_id-">
                                <a href="#endpoints-DELETEapi-admin-fields--field_id-">DELETE api/admin/fields/{field_id}</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>API for booking and managing padel fields.</p>
<aside>
...
<p>You can retrieve your token by making a POST request to the <code>/api/login</code> endpoint.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-user">PUT api/user</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-fields">GET api/fields</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-fields--field_id-">GET api/fields/{field_id}</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/fields/1" \
    --header "Authorization: Bearer Bearer {TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<form id="form-GETapi-fields--field_id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-fields--field_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-fields--field_id-"
                    onclick="cancelTryOut('GETapi-fields--field_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>The ID of the field. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-GETapi-fields--field_id--availability">GET api/fields/{field_id}/availability</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/fields/1/availability" \
    --header "Authorization: Bearer Bearer {TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/fields/1/availability"
);
...
<form id="form-GETapi-fields--field_id--availability" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-fields--field_id--availability');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-fields--field_id--availability"
                    onclick="cancelTryOut('GETapi-fields--field_id--availability');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid date in the format <code>Y-m-d</code>. Example: <code>2025-07-05</code></p>
        </div>
        </form>

                    <h2 id="endpoints-POSTapi-bookings-calculate-price">POST api/bookings/calculate-price</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/bookings/calculate-price" \
    --header "Authorization: Bearer Bearer {TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"field_id\": \"consequatur\",
    \"start_time\": \"2106-08-04\",
    \"end_time\": \"2106-08-04\"
}"
</code></pre></div>
...
<form id="form-POSTapi-bookings-calculate-price" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-bookings-calculate-price');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-bookings-calculate-price"
                    onclick="cancelTryOut('POSTapi-bookings-calculate-price');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after <code>now</code>. Example: <code>2106-08-04</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after <code>start_time</code>. Example: <code>2106-08-04</code></p>
        </div>
        </form>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-bookings--booking_id-">GET api/bookings/{booking_id}</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/bookings/17" \
    --header "Authorization: Bearer Bearer {TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/bookings/17"
);
...
<p>Must be a valid date. Must be a date after <code>start_time</code>. Example: <code>2106-08-04</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-bookings--booking_id-">PUT api/bookings/{booking_id}</h2>
...
<form id="form-PUTapi-bookings--booking_id-" data-method="PUT"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PUTapi-bookings--booking_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-bookings--booking_id-"
                    onclick="cancelTryOut('PUTapi-bookings--booking_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>Must be a valid date. Must be a date after <code>start_time</code>. Example: <code>2106-08-04</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-bookings--booking_id-">DELETE api/bookings/{booking_id}</h2>
...
<form id="form-DELETEapi-bookings--booking_id-" data-method="DELETE"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('DELETEapi-bookings--booking_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-bookings--booking_id-"
                    onclick="cancelTryOut('DELETEapi-bookings--booking_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>The ID of the booking. Example: <code>17</code></p>
                    ...
                    <h2 id="endpoints-GETapi-admin-statistics-revenue">GET api/admin/statistics/revenue</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/admin/statistics/revenue" \
    --header "Authorization: Bearer Bearer {TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/admin/statistics/revenue"
);
...
<form id="form-GETapi-admin-statistics-revenue" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-admin-statistics-revenue');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-admin-statistics-revenue"
                    onclick="cancelTryOut('GETapi-admin-statistics-revenue');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-admin-statistics-field-performance">GET api/admin/statistics/field-performance</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/admin/statistics/field-performance" \
    --header "Authorization: Bearer Bearer {TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/admin/statistics/field-performance"
);
...
<form id="form-GETapi-admin-statistics-field-performance" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-admin-statistics-field-performance');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-admin-statistics-field-performance"
                    onclick="cancelTryOut('GETapi-admin-statistics-field-performance');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-admin-fields">POST api/admin/fields</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/admin/fields" \
    --header "Authorization: Bearer Bearer {TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<form id="form-POSTapi-admin-fields" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-admin-fields');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-admin-fields"
                    onclick="cancelTryOut('POSTapi-admin-fields');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>Example: <code>false</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-admin-fields--field_id-">PUT api/admin/fields/{field_id}</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "http://localhost/api/admin/fields/1" \
    --header "Authorization: Bearer Bearer {TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<form id="form-PUTapi-admin-fields--field_id-" data-method="PUT"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PUTapi-admin-fields--field_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-admin-fields--field_id-"
                    onclick="cancelTryOut('PUTapi-admin-fields--field_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>Example: <code>false</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-admin-fields--field_id-">DELETE api/admin/fields/{field_id}</h2>
...
<form id="form-DELETEapi-admin-fields--field_id-" data-method="DELETE"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('DELETEapi-admin-fields--field_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-admin-fields--field_id-"
                    onclick="cancelTryOut('DELETEapi-admin-fields--field_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
