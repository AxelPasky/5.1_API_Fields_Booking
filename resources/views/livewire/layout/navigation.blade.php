...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" wire:navigate>
                        <img src="{{ asset('images/logo.svg') }}" alt="Logo" class="block h-9 w-auto">
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                        ...
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            <div class="inline-flex items-center">
                                ...
                                @if(Auth::user()->is_admin)
                                    <span class="ml-1 text-xs text-red-500">(Admin)</span>
                                @endif
                            </div>
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link :href="route('bookings.index')" wire:navigate>
                            {{ __('My Bookings') }}
                        </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800 inline-flex items-center" >
                    <div x-data="{{ json_encode(['name' => auth()->user()->name]) }}" x-text="name" x-on:profile-updated.window="name = $event.detail.name"></div>
                    @if(Auth::user()->is_admin)
                        <span class="ml-1 text-xs text-red-500">(Admin)</span>
                    @endif
