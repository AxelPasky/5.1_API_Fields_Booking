...
return [
    ...
    'description' => 'API for booking and managing padel fields.',
    ...
    'auth' => [
        ...
        // Options: query, body, bearer, header
        'in' => 'bearer',
        ...
        'extra_info' => 'You can retrieve your token by making a POST request to the `/api/login` endpoint.',
    ],
